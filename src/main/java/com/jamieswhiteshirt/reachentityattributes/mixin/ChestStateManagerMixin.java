...
abstract class ChestStateManagerMixin {
    ...
    @Redirect(
        ...
        at = @At(value = "INVOKE", opcode = Opcodes.INVOKEVIRTUAL,
            target = "Lnet/minecraft/block/entity/ChestStateManager;getInRangeViewerCount(Lnet/minecraft/world/World;Lnet/minecraft/util/math/BlockPos;)I"))
    private int getReachAccountingOpenCount(final ChestStateManager manager, final World world, final BlockPos pos) {
