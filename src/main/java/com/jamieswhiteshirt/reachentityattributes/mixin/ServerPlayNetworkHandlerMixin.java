...
abstract class ServerPlayNetworkHandlerMixin {
    ...
    private double getActualAttackRange(final double attackRange, final PlayerInteractEntityC2SPacket packet) {
        if (packet.getType() == PlayerInteractEntityC2SPacket.InteractionType.ATTACK) {
            return ReachEntityAttributes.getSquaredAttackRange(((ServerPlayNetworkHandler) (Object) this).player, attackRange);
        }
        // INTERACT, INTERACT_AT
        return ReachEntityAttributes.getSquaredReachDistance(((ServerPlayNetworkHandler) (Object) this).player, attackRange);
    }
    ...
    private double getActualReachDistance(final double reachDistance) {
        return ReachEntityAttributes.getSquaredReachDistance(((ServerPlayNetworkHandler) (Object) this).player, reachDistance);
    }
}
